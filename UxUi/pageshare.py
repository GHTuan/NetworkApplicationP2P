...
class Ui_Sharewindow(object):
    def setupUi(self, Sharewindow):
        ...
        self.un_share_btn = QtWidgets.QPushButton(parent=self.centralwidget)
        self.un_share_btn.setGeometry(QtCore.QRect(180, 320, 75, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        font.setStrikeOut(False)
        self.un_share_btn.setFont(font)
        self.un_share_btn.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.un_share_btn.setStyleSheet("border-color: rgb(0, 0, 127);")
        self.un_share_btn.setObjectName("un_share_btn")
        self.label_2 = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(30, 260, 231, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.unshare_box = QtWidgets.QLineEdit(parent=self.centralwidget)
        self.unshare_box.setGeometry(QtCore.QRect(140, 290, 221, 20))
        self.unshare_box.setObjectName("unshare_box")
    ...
    def retranslateUi(self, Sharewindow):
        ...
        self.un_share_btn.setText(_translate("Sharewindow", "UNSHARE"))
        self.label_2.setText(_translate("Sharewindow", "Enter your file you want unpublic:"))
