...
class Ui_Sharewindow(object):
    def setupUi(self, Sharewindow):
        ...
        self.disconect.setGeometry(QtCore.QRect(180, 340, 75, 23))
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.back1.setGeometry(QtCore.QRect(20, 340, 75, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, Sharewindow):
        ...
        self.disconect.setText(_translate("Sharewindow", "DISCONECT"))
